...
<body style="background-color: #ececec!important;">
    <!-- bouton croix pour retourner a la page d'accueil -->
                            ...
                            <div class="card-body py-5 px-md-5" style="background-color: #ececec!important; border: 1px solid #2f435e!important; border-radius: 0.25em">
                                ...
                                <form method="post" action="?action=connexionUser" style="background-color: #ececec!important;">
                                    ...
                                    <div class="form-outline mb-4">
                                        <input id="username" class="form-control" name="username" type="text" style="background-color: #ececec!important;border-color:#2f435e" />
                                        <label class="form-label" for="username">Nom d'utilisateur</label>
                                    </div>

                                    <div class="form-outline mb-4">
                                        <input id="password" class="form-control" name="password" type="password" style="background-color: #ececec!important;border-color:#2f435e" />
